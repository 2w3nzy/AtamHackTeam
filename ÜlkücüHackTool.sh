...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red  ÜlkücüHackTeam"
    echo -e $cyan"    Instagram           $white":" $red @ÜlkücüHackTeamOwner0123"
    echo -e $cyan"    Developer           $white":" $red  ÜlkücüHackTeam
    exit 0
fi
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Create by           $white":" $red ülkücüHaxkTeam(blink}${lightgreen}                        |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Github              $white":" $red https://github.com/2w3nzy ${blink}${lightgreen}     |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Instagram           $white":" $red 2w3nzy ${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ---------------------------------------------------------$tp\n"
echo "  ~~~~~~~~~~~~~~~~~~~~~ ÜlkücüHackTeam~~~~~~~~~~~~~~~~~~~~~~~~~" 
        echo ""
